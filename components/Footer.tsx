...
const REMIX_SUGGESTIONS = [
  "Idea de remix: Permitir a los usuarios cambiar el color de la caja de regalo.",
  "Idea de remix: Añadir diferentes productos dentro de la caja.",
  "Idea de remix: Añadir cintas decorativas o mensajes personalizados.",
  "Idea de remix: Generar la caja en diferentes entornos (ej. sobre una mesa).",
  "Idea de remix: Permitir guardar las maquetas en una galería.",
  "Idea de remix: Crear un GIF animado de la caja girando.",
];
